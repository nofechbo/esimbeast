    ...
    <PlanPageWrapper>
      ...
      <DetailsBox>
        ...
        <PlanDetails>
          ...
          <Strong>{plan.Activation}PLACEHOLDER</Strong>, eKYC (ID verification):{" "}
          <Strong>{plan.eKYC ? "" : "Not "}Required</Strong>, Delivery:{" "}
          <Strong>{plan.Delivery}PLACEHOLDER; 24/7 support.</Strong>
        </PlanDetails>
        ...
        <MoreDetailsTitle>More details</MoreDetailsTitle>
        ...
        {plan.reducedSpeed && (
          <PlanDetails>
            ...
            to apply a Fair Usage Policy. Hotspot: enjoy {plan.reducedSpeed} per
            day to share with others.
          </PlanDetails>
        )}
